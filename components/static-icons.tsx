// Lucide/Feather paths; licenses are retained in THIRD_PARTY_NOTICES.md.
// Decorative SVG needs no client component or hydration on the static host.
...
export function Trophy({ className, strokeWidth = 2 }: IconProps) {
  return (
    <svg {...attributes} className={className} strokeWidth={strokeWidth}>
...
export function ExternalLink({ className, strokeWidth = 2 }: IconProps) {
  return (
    <svg {...attributes} className={className} strokeWidth={strokeWidth}>
      <path d="M15 3h6v6" />
      <path d="M10 14 21 3" />
